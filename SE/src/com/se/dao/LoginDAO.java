...
public class LoginDAO extends BaseHibernateDAO {
	...
	public Login findById(java.lang.String id) {
		...
		try {
			Login instance = (Login) getSession().get("com.se.model.Login", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Login instance) {
		...
		try {
			List results = getSession().createCriteria("com.se.model.Login")
